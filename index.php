    ...
    <section>
        <div class="main-about">
            <div class="container">
                ...
                <div class="main-about__img lazy" data-bg="url(<?=SITE_TEMPLATE_PATH?>/images/main-about.png)" style="background-image: url(&quot;<?=SITE_TEMPLATE_PATH?>/images/main-about.png&quot;);" data-was-processed="true"></div>
    </section>
    <section>
        <?php
        global $filterAll;
