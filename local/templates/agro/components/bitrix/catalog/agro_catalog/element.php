...
if (!empty($GLOBALS['SECTION_ID'])):?>
    <section>
        <div class="extra-block">
            <div class="container">
                <?php
                global $filterId;
                $filterId = ['!=ID' => $GLOBALS['ELEMENT_ID']];
                $APPLICATION->IncludeComponent(
                    "bitrix:catalog.section",
                    "agro_from_category",
                    array(
                        "TITLE" => "Из этой же <b>категории:</b>",
                        "IBLOCK_TYPE" => $arParams["IBLOCK_TYPE"],
                        "IBLOCK_ID" => $arParams["IBLOCK_ID"],
    ...
    <?php if (!empty($GLOBALS['ADDITIONAL_PRODUCT'])): ?>
        <section>
            <div class="extra-block">
                <div class="container">
                    <?php
                    global $filterAdditional;
                    $filterAdditional = ['!=ID' => $GLOBALS['ELEMENT_ID'], 'ID' => $GLOBALS['ADDITIONAL_PRODUCT']];
                    $APPLICATION->IncludeComponent(
                        "bitrix:catalog.section",
                        "agro_from_category",
                        array(
